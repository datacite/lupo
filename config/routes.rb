Rails.application.routes.draw do
  ...
  get "/dois/application/vnd.datacite.datacite+json/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :datacite_json }
  get "/dois/application/vnd.crosscite.crosscite+json/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :crosscite }
  get "/dois/application/vnd.schemaorg.ld+json/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :schema_org }
  get "/dois/application/ld+json/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :schema_org }
  get "/dois/application/vnd.codemeta.ld+json/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :codemeta }
  get "/dois/application/vnd.citationstyles.csl+json/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :citeproc }
  get "/dois/application/vnd.jats+xml/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :jats }
  get "/dois/application/x-bibtex/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :bibtex }
  get "/dois/application/x-research-info-systems/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :ris }
  get "/dois/text/csv/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :csv }
  get "/dois/text/x-bibliography/:id", to: "datacite_dois#show", constraints: { id: /.+/ }, defaults: { format: :citation }

  # content negotiation for collections
  get "/dois/application/vnd.datacite.datacite+xml", to: "datacite_dois#index", defaults: { format: :datacite }
  get "/dois/application/vnd.datacite.datacite+json", to: "datacite_dois#index", defaults: { format: :datacite_json }
  get "/dois/application/vnd.crosscite.crosscite+json", to: "datacite_dois#index", defaults: { format: :crosscite }
  get "/dois/application/vnd.schemaorg.ld+json", to: "datacite_dois#index", defaults: { format: :schema_org }
  get "/dois/application/ld+json", to: "datacite_dois#index", defaults: { format: :schema_org }
  get "/dois/application/vnd.codemeta.ld+json", to: "datacite_dois#index", defaults: { format: :codemeta }
  get "/dois/application/vnd.citationstyles.csl+json", to: "datacite_dois#index", defaults: { format: :citeproc }
  get "/dois/application/vnd.jats+xml", to: "datacite_dois#index", defaults: { format: :jats }
  get "/dois/application/x-bibtex", to: "datacite_dois#index", defaults: { format: :bibtex }
  get "/dois/application/x-research-info-systems", to: "datacite_dois#index", defaults: { format: :ris }
  get "/dois/text/csv", to: "datacite_dois#index", defaults: { format: :csv }
  get "/dois/text/x-bibliography", to: "datacite_dois#index", defaults: { format: :citation }
  ...
  # Reporting
  get "export/organizations", to: "exports#organizations", defaults: { format: :csv }
  get "export/repositories", to: "exports#repositories", defaults: { format: :csv }
  ...
  resources :data_centers, only: %i[show index], constraints: { id: /.+/ }, path: "/data-centers"
  resources :works, only: %i[show index], constraints: { id: /.+/ }

  # content negotiation
  resources :index, path: "/", only: %i[show index], constraints: { id: /.+/, format: false }
