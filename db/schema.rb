...
ActiveRecord::Schema.define(version: 2020_05_16_052834) do
  ...
  create_table "dois", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at"
  ...
  create_table "lhma_2020_05_16_05_17_41_957_allocator", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "lhma_2020_05_16_05_18_13_968_allocator", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "system_email", null: false
    t.datetime "created_at"
    t.boolean "is_active", default: true
    t.string "name", null: false
    ...
    t.index ["organization_type"], name: "index_allocator_organization_type"
    t.index ["symbol"], name: "symbol", unique: true
    t.index ["uid"], name: "index_uid"
  end

  create_table "lhma_2020_05_16_05_20_18_326_allocator", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "system_email", null: false
    t.datetime "created"
  ...
  create_table "lhma_2020_05_16_05_20_48_554_allocator", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "system_email", null: false
    t.datetime "created_at"
    t.boolean "is_active", default: true
    t.string "name", null: false
  ...
  create_table "lhma_2020_05_16_05_24_09_583_allocator", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "system_email", null: false
    t.datetime "created"
    t.binary "is_active", limit: 1, default: "b'1'"
    t.string "name", null: false
  ...
  create_table "lhma_2020_05_16_05_24_39_468_allocator", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "system_email", null: false
    t.datetime "created_at"
    t.boolean "is_active", default: true
    t.string "name", null: false
  ...
  create_table "lhma_2020_05_16_05_27_14_658_allocator", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "system_email", null: false
    t.datetime "created"
    t.binary "is_active", limit: 1, default: "b'1'"
    t.string "name", null: false
  ...
  create_table "lhma_2020_05_16_05_27_43_496_allocator", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "system_email", null: false
    t.datetime "created_at"
    t.boolean "is_active", default: true
    t.string "name", null: false
  ...
  create_table "lhma_2020_05_16_05_28_14_257_allocator", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "system_email", null: false
    t.datetime "created"
    t.binary "is_active", limit: 1, default: "b'1'"
    t.string "name", null: false
  ...
  create_table "lhma_2020_05_16_05_36_52_423_dataset", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created"
    t.string "doi", null: false
  ...
  create_table "lhma_2020_05_16_05_37_26_400_dataset", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at"
    t.string "doi", null: false
    t.boolean "is_active", default: true
    t.integer "last_landing_page_status"
  ...
  create_table "lhma_2020_05_16_05_38_03_286_dataset", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created"
    t.string "doi", null: false
  ...
  create_table "members", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "logo_updated_at"
    t.string "uid", limit: 32
    t.index ["globus_uuid"], name: "index_members_on_globus_uuid"
    t.index ["organization_type"], name: "index_allocator_organization_type"
    t.index ["symbol"], name: "symbol", unique: true
    t.index ["uid"], name: "index_uid"
  end
  ...
  create_table "repositories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "globus_uuid", limit: 191
    t.string "uid", limit: 32
    t.index ["globus_uuid"], name: "index_repositories_on_globus_uuid"
    t.index ["member_id"], name: "FK6695D60546EBD781"
    t.index ["re3data_id"], name: "index_repositories_on_re3data_id"
    t.index ["symbol"], name: "symbol", unique: true
    t.index ["uid"], name: "index_uid"
    t.index ["url"], name: "index_repositories_on_url", length: 100
  end

  add_foreign_key "client_prefixes", "prefixes", name: "FK13A1B3BAAF86A1C7", on_delete: :cascade
  add_foreign_key "provider_prefixes", "lhma_2020_05_16_05_20_18_326_allocator", column: "provider_id", name: "FK13A1B3BA47B5F5FF", on_delete: :cascade
  add_foreign_key "provider_prefixes", "prefixes", name: "FKE7FBD674AF86A1C7", on_delete: :cascade
end
