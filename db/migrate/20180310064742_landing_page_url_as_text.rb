...
class LandingPageUrlAsText < ActiveRecord::Migration[5.1]
  def up
    safety_assured { change_column :dataset, :last_landing_page, :text, limit: 65535 }
  ...
  def down
    remove_index :dataset, name: "index_dataset_on_last_landing_page_status", column: :last_landing_page_status
    remove_index :dataset, name: "index_dataset_on_last_landing_page_content_type", column: :last_landing_page_content_type
