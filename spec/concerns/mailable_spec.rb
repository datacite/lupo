...
describe "Mailable", type: :model, vcr: true do
  ...
  it "format_message_text" do
    ...
    text = User.format_message_text(template: template, contact_name: client.contact_name, name: client.symbol, url: token)
    line = text.split("\n").first
  ...
  it "format_message_html" do
    ...
    html = User.format_message_html(template: template, contact_name: client.contact_name, name: client.symbol, url: token)
    line = html.split("\n")[41]
