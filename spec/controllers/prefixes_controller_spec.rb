...
#
#         post :create, {prefix: invalid_attributes}, valid_session
...
#         prefix = Prefix.create! valid_attributes
#         put :update, {id: prefix.to_param, prefix: new_attributes}, valid_session
#         prefix.reload
...
#         prefix = Prefix.create! valid_attributes
#
#         put :update, {id: prefix.to_param, prefix: invalid_attributes}, valid_session
#         expect(response).to have_http_status(:unprocessable_entity)
#         expect(response.content_type).to eq('application/json')
#       end
#     end
