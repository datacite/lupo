...
describe RepositoryPrefixesController, type: :request do
  ...
  describe "GET /v3/repository-prefixes", elasticsearch: true do
    before do
      Prefix.import
      ClientPrefix.import
      sleep 2
    ...
    it "returns repository-prefixes" do
      get "/v3/repository-prefixes", nil, headers
    ...
    it "returns repository-prefixes by repository-id" do
      get "/v3/repository-prefixes?repository-id=#{
    ...
    it "returns repository-prefixes by prefix-id" do
      get "/v3/repository-prefixes?prefix-id=#{client_prefixes.first.prefix_id}",
          nil, headers
    ...
    it "returns repository-prefixes by partial prefix" do
      get "/v3/repository-prefixes?query=10.508", nil, headers
    ...
    it "returns prefixes by client-id" do
      get "/v3/prefixes?client-id=#{client_prefixes.first.client_id}",
          nil, headers
  ...
  describe "GET /v3/repository-prefixes/:uid" do
    context "when the record exists" do
      it "returns the repository-prefix" do
        get "/v3/repository-prefixes/#{client_prefix.uid}",
            nil, headers
    ...
    context "when the record does not exist" do
      it "returns status code 404" do
        get "/v3/repository-prefixes/xxx", nil, headers
  ...
  describe "PATCH /v3/repository-prefixes/:uid" do
    it "returns method not supported error" do
      patch "/v3/repository-prefixes/#{client_prefix.uid}",
            nil, headers
  ...
  describe "DELETE /v3/repository-prefixes/:uid", elasticsearch: true do
    let!(:client_prefix) do
      create(
        :client_prefix,
        client: client, prefix: prefix, provider_prefix: provider_prefix,
    ...
    it "deletes a repository-prefix" do
      delete "/v3/repository-prefixes/#{client_prefix.uid}",
             nil, headers
  ...
  describe "POST /v3/repository-prefixes", elasticsearch: true do
    before do
      Prefix.import
      Client.import
    ...
    context "when the request is valid" do
      ...
      it "creates a repository-prefix" do
        post "/v3/repository-prefixes", valid_attributes, headers
