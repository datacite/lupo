...
describe MetadataController, type: :request do
  ...
  describe "GET /v3/dois/DOI/metadata/:id" do
    ...
    context "when the record does not exist" do
      it "returns status code 404" do
        get "/v3/dois/#{datacite_doi.doi}/metadata/xxxx",
            nil, headers
  ...
  describe "DELETE /v3/dois/DOI/metadata/:id" do
    context "when the resources does exist" do
      it "returns status code 204" do
        delete "/v3/dois/#{datacite_doi.doi}/metadata/#{metadata.uid}",
               nil, headers
    ...
    context "when the resources doesnt exist" do
      it "returns status code 404" do
        delete "/v3/dois/#{datacite_doi.doi}/metadata/xxx",
               nil, headers
