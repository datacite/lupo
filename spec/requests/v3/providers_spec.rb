...
describe ProvidersController, type: :request, elasticsearch: true do
  ...
  describe "GET /v3/providers for consortium" do
    let(:consortium) do
    ...
    it "returns providers" do
      get "/v3/providers?consortium-id=dc", nil, headers
  ...
  describe "GET /v3/providers/:id" do
    context "when the record exists" do
      it "returns the provider" do
        get "/v3/providers/#{provider.symbol.downcase}",
            nil, headers
    ...
    context "when the record does not exist" do
      it "returns a not found message" do
        get "/v3/providers/xxx", nil, headers
  ...
  describe "GET /v3/providers/:id with contacts" do
    ...
    context "when the record exists" do
      it "returns the provider" do
        get "/v3/providers/#{provider.symbol.downcase}?include=contacts",
            nil, headers
  ...
  describe "GET /v3/providers/:id meta" do
    let(:provider) { create(:provider) }
  ...
  describe "GET /v3/providers/totals" do
    ...
    it "returns providers" do
      get "/v3/providers/totals", nil, headers
  ...
  describe "GET /v3/providers/:id/stats" do
    let(:provider) { create(:provider) }
    let(:client) { create(:client, provider: provider) }
    let!(:dois) do
      create_list(
    ...
    it "returns provider" do
      get "/v3/providers/#{provider.symbol.downcase}/stats",
          nil, headers
  ...
  describe "POST /v3/providers" do
    ...
    context "request ability check" do
      ...
      it "has no permission" do
        get "/v3/providers/#{providers.first.symbol}",
            nil, headers_last
    ...
    context "create provider member_role contractual_member" do
      ...
      it "creates a provider" do
        post "/v3/providers", params, admin_headers
  ...
  describe "PUT /v3/providers/:id" do
    context "when the record exists" do
      let(:params) do
        {
          "data" => {
    ...
    context "when the resource doesn't exist" do
      ...
      it "returns status code 404" do
        put "/v3/providers/xxx", params, headers
  ...
  describe "DELETE /v3/providers/:id" do
    let!(:provider) { create(:provider) }
    ...
    it "deletes the provider" do
      delete "/v3/providers/#{provider.symbol.downcase}",
             nil, admin_headers
