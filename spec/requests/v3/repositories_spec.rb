...
describe RepositoriesController, type: :request, elasticsearch: true do
  ...
  describe "GET /v3/repositories", elasticsearch: true do
    ...
    it "returns repositories" do
      get "/v3/repositories", nil, headers
  ...
  describe "GET /v3/repositories/:id" do
    context "when the record exists" do
      it "returns the repository" do
        get "/v3/repositories/#{client.uid}", nil, headers
    ...
    context "when the record does not exist" do
      it "returns status code 404" do
        get "/v3/repositories/xxx", nil, headers
  ...
  describe "GET /v3/repositories/totals" do
    ...
    it "returns repositories" do
      get "/v3/repositories/totals", nil, headers
  ...
  describe "GET /v3/repositories/:id meta" do
    ...
    it "returns repository" do
      get "/v3/repositories/#{client.uid}"
  ...
  describe "GET /v3/repositories/:id/stats" do
    let(:provider) { create(:provider) }
    let(:client) { create(:client) }
    let!(:datacite_dois) do
      create_list(
    ...
    it "returns repository" do
      get "/v3/repositories/#{client.uid}/stats"
  ...
  describe "POST /v3/repositories" do
    context "when the request is valid" do
      it "creates a repository" do
        post "/v3/repositories", params, headers
    ...
    context "consortium" do
      it "creates a repository" do
        post "/v3/repositories", params, consortium_headers
  ...
  describe "PUT /v3/repositories/:id" do
    context "when the record exists" do
      let(:params) do
        {
          "data" => {
    ...
    context "consortium" do
      ...
      it "updates the record" do
        put "/v3/repositories/#{client.symbol}",
    ...
    context "transfer repository" do
      ...
      it "updates the record" do
        ...
        get "/v3/providers/#{provider.symbol}"

        expect(
          json.dig("data", "relationships", "prefixes", "data"),
        ).to be_empty

        get "/v3/providers/#{new_provider.symbol}"

        expect(
          json.dig("data", "relationships", "prefixes", "data").first.dig("id"),
        ).to eq(prefix.uid)

        get "/v3/prefixes/#{prefix.uid}"
        expect(
  ...
  describe "DELETE /v3/repositories/:id" do
    it "returns status code 204" do
      delete "/v3/repositories/#{client.uid}", nil, headers

      expect(last_response.status).to eq(204)
    end

    it "returns status code 204 with consortium" do
      delete "/v3/repositories/#{client.uid}",
    ...
    context "when the resource doesnt exist" do
      it "returns status code 404" do
        delete "/v3/repositories/xxx", nil, headers
