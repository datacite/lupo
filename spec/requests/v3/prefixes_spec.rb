...
describe PrefixesController, type: :request, elasticsearch: true do
  ...
  describe "GET /v3/prefixes" do
    ...
    it "returns prefixes by id" do
      get "/v3/prefixes?id=#{prefixes.first.uid}", nil, headers
    ...
    it "returns prefixes by query" do
      get "/v3/prefixes?query=10.508", nil, headers
  ...
  describe "GET /v3/prefixes/:id" do
    before do
      Prefix.import
      sleep 2
    end
    ...
    context "when the record exists" do
      it "returns status code 200" do
        get "/v3/prefixes/#{prefix_id}", nil, headers
    ...
    context "when the prefix does not exist" do
      it "returns status code 404" do
        get "/v3/prefixes/10.1234", nil, headers
    ...
    context "when the record does not exist" do
      it "returns status code 404" do
        get "/v3/prefixes/xxx", nil, headers
  ...
  describe "PATCH /v3/prefixes/:prefix_id" do
    it "returns method not supported error" do
      patch "/v3/prefixes/#{prefix_id}", nil, headers
  ...
  describe "POST /v3/prefixes" do
    ...
    context "when the request is valid" do
      ...
      it "returns status code 201" do
        post "/v3/prefixes", valid_attributes, headers
    ...
    context "when the request is invalid" do
      ...
      it "returns status code 422" do
        post "/v3/prefixes", not_valid_attributes, headers
  ...
  describe "DELETE /v3/prefixes/:id" do
    it "returns status code 204" do
      delete "/v3/prefixes/#{prefix_id}", nil, headers
