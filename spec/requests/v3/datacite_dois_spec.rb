...
describe DataciteDoisController, type: :request, vcr: true do
  ...
  describe "GET /v3/dois", elasticsearch: true do
    ...
    it "returns dois with scroll" do
      get "/v3/dois?page[scroll]=1m&page[size]=4", nil, headers
    ...
    xit "returns dois with offset" do
      ...
      next_link_absolute = Addressable::URI.parse(json.dig("links", "next"))
      next_link = next_link_absolute.path + "?" + next_link_absolute.query
      expect(next_link).to eq("/v3/dois?page%5Bnumber%5D=2&page%5Bsize%5D=4")
      ...
      next_link_absolute = Addressable::URI.parse(json.dig("links", "next"))
      next_link = next_link_absolute.path + "?" + next_link_absolute.query
      expect(next_link).to eq("/v3/dois?page%5Bnumber%5D=3&page%5Bsize%5D=4")
    ...
    it "returns dois with cursor" do
      get "/v3/dois?page[cursor]&page[size]=4", nil, headers
    ...
    it "returns dois with version query", vcr: true do
      get "/v3/dois?query=version:testtag", nil, headers
    ...
    it "returns dois with extra detail", vcr: true do
      get "/v3/dois?detail=true", nil, headers
  ...
  describe "GET /v3/dois with query", elasticsearch: true do
    let!(:doi) do
    ...
    it "returns dois with short orcid id", vcr: true do
      get "/v3/dois?user-id=0000-0003-3484-6875", nil, headers
    ...
    it "returns dois with orcid id", vcr: true do
      get "/v3/dois?user-id=orcid.org/0000-0003-3484-6875", nil, headers
    ...
    it "returns dois with orcid id as url", vcr: true do
      get "/v3/dois?user-id=https://orcid.org/0000-0003-3484-6875", nil, headers
    ...
    it "returns dois with crossref funder id", vcr: true do
      get "/v3/dois?funder-id=10.13039/501100009053", nil, headers
    ...
    it "returns dois with multiple crossref funder id", vcr: true do
      get "/v3/dois?funder-id=10.13039/501100009053,10.13039/501100000735", nil, headers
    ...
    it "returns dois with crossref funder id as url", vcr: true do
      get "/v3/dois?funder-id=https://doi.org/10.13039/501100009053", nil, headers
    ...
    it "returns dois with short ror id", vcr: true do
      get "/v3/dois?affiliation-id=046ak2485&affiliation=true", nil, headers
    ...
    it "returns dois with ror id", vcr: true do
      get "/v3/dois?affiliation-id=ror.org/046ak2485&affiliation=true", nil, headers
    ...
    it "returns dois with ror id as url", vcr: true do
      get "/v3/dois?affiliation-id=https://ror.org/046ak2485&affiliation=true", nil, headers
    ...
    it "returns dois with full name", vcr: true do
      get "/v3/dois?query=Kristian%20Garza&affiliation=true", nil, headers
    ...
    it "returns dois with field of science", vcr: true do
      get "/v3/dois?field-of-science=computer_and_information_sciences", nil, headers
  ...
  describe "GET /v3/dois/:id", elasticsearch: true do
    ...
    context "when the record does not exist" do
      it "returns status code 404" do
        get "/v3/dois/10.5256/xxxx", nil, headers
    ...
    context "provider_admin" do
      ...
      it "returns the Doi" do
        get "/v3/dois/#{doi.doi}", nil, provider_headers
  ...
  describe "GET /v3/dois for dissertations", elasticsearch: true, vcr: true do
    ...
    it "filter for dissertations" do
      get "/v3/dois?resource-type=Dissertation", nil, headers
  ...
  describe "GET /v3/dois for instruments", elasticsearch: true, vcr: true do
    ...
    it "filter for instruments" do
      get "/v3/dois?resource-type=Instrument", nil, headers
  ...
  describe "GET /v3/dois for interactive resources", elasticsearch: true, vcr: true do
    ...
    it "filter for interactive resources" do
      get "/v3/dois?resource-type-id=interactive-resource", nil, headers
    ...
    it "filter for interactive resources no facets" do
      get "/v3/dois?resource-type-id=interactive-resource&disable-facets=true", nil, headers
  ...
  describe "GET /v3/dois for fake resources", elasticsearch: true, vcr: true do
    ...
    it "filter for fake resources" do
      get "/v3/dois?resource-type-id=fake", nil, headers
  ...
  describe "GET /v3/dois with views and downloads", elasticsearch: true, vcr: true do
  ...
  describe "state" do
    ...
    context "register" do
      ...
      it "creates the record" do
        patch "/v3/dois/#{doi_id}", valid_attributes, headers
  ...
  describe "PATCH /v3/dois/:id" do
    ...
    context "update sizes" do
      ...
      it "updates the doi" do
        put "/v3/dois/#{doi.doi}", valid_attributes, admin_headers
    ...
    context "no creators validate" do
      ...
      it "returns error" do
        put "/v3/dois/#{doi.doi}", valid_attributes, headers
    ...
    context "schema 2.2" do
      ...
      it "returns status code 422" do
        patch "/v3/dois/10.14454/10703", valid_attributes, headers
    ...
    context "when the record doesn't exist" do
      ...
      it "creates the record" do
        put "/v3/dois/#{doi_id}", valid_attributes, headers
    ...
    context "when a doi is created ignore reverting back" do
      ...
      it "creates the record" do
        post "/v3/dois", valid_attributes, headers
      ...
      it "revert the changes" do
        ...
        expect(last_response.status).to eq(201)
        post "/v3/dois/undo", undo_attributes, headers
    ...
    context "fail when we transfer a DOI as provider" do
      ...
      it "returns errors" do
        put "/v3/dois/#{doi.doi}", valid_attributes.to_json, provider_headers
  ...
  describe "POST /v3/dois" do
    ...
    context "with affiliation and query parameter" do
      ...
      it "validates a Doi" do
        post "/v3/dois?affiliation=true", params, headers
    ...
    context "schema_org" do
      ...
      it "updates the record" do
        patch "/v3/dois/10.14454/8na3-9s47", valid_attributes, headers
    ...
    context "datacite url", vcr: true do
      ...
      it "updates the record" do
        patch "/v3/dois/10.14454/q6g15xs4", valid_attributes, headers
    ...
    context "when the request is invalid" do
      ...
      it "returns a validation failure message" do
        post "/v3/dois", not_valid_attributes, headers
    ...
    describe "POST /dois/validate" do
      context "validates" do
        ...
        it "validates a Doi" do
          post "/v3/dois/validate", params, headers
    ...
    context "mds doi" do
      ...
      it "add metadata" do
        put "/v3/dois/10.14454/10703", update_attributes, headers
    ...
    context "update multiple affiliations" do
      ...
      it "updates the Doi" do
        patch "/v3/dois/#{doi.doi}?affiliation=true", update_attributes, headers
    ...
    context "remove series_information via xml", elasticsearch: true do
      ...
      it "updates the Doi" do
        ...
        patch "/v3/dois/#{doi.doi}", update_attributes_again, headers
    ...
    context "landing page" do
      ...
      it "creates a doi" do
        post "/v3/dois", valid_attributes.to_json, { "HTTP_ACCEPT" => "application/vnd.api+json", "CONTENT_TYPE" => "application/vnd.api+json", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "update with landing page info as admin" do
      ...
      it "creates a doi" do
        put "/v3/dois/#{doi.doi}", valid_attributes.to_json, { "HTTP_ACCEPT" => "application/vnd.api+json", "CONTENT_TYPE" => "application/vnd.api+json", "HTTP_AUTHORIZATION" => "Bearer " + admin_bearer }
  ...
  describe "DELETE /v3/dois/:id" do
    let(:doi) { create(:doi, client: client, aasm_state: "draft") }

    it "returns status code 204" do
      delete "/v3/dois/#{doi.doi}", nil, headers
  ...
  describe "DELETE /v3/dois/:id findable state" do
    let(:doi) { create(:doi, client: client, aasm_state: "findable") }
  ...
  describe "POST /v3/dois/set-url", elasticsearch: true do
    let!(:dois) { create_list(:doi, 3, client: client, url: nil) }

    it "returns dois" do
      post "/v3/dois/set-url", nil, admin_headers
  ...
  describe "GET /v3/dois/random" do
    it "returns random doi" do
      get "/v3/dois/random?prefix=10.14454", headers: headers
  ...
  describe "GET /v3/dois/<doi> linkcheck results", elasticsearch: true do
    let(:landing_page) do
      {
        "checked" => Time.zone.now.utc.iso8601,
        "status" => 200,
    ...
    context "client authorised try get diff dois landing data" do
      ...
      it "returns with landing page results" do
        get "/v3/dois/#{other_doi.doi}", nil, headers
  ...
  describe "GET /dois/random?prefix" do
    it "returns random doi with prefix" do
      get "/v3/dois/random?prefix=#{prefix.uid}", nil, headers
  ...
  describe "GET /v3/dois/random?number" do
    let(:number) { 122149076 }

    it "returns predictable doi" do
      get "/v3/dois/random?prefix=10.14454&number=#{number}", nil, headers
  ...
  describe "GET /v3/dois/DOI/get-url", vcr: true, elasticsearch: true do
    context "it works" do
      ...
      it "returns url" do
        get "/v3/dois/#{doi.doi}/get-url", nil, headers
    ...
    context "not found" do
      ...
      it "returns not found" do
        get "/v3/dois/#{datacite_doi.doi}/get-url", nil, headers
  ...
  describe "GET /v3/dois/get-dois", vcr: true do
  ...
  describe "GET /v3/dois/get-dois no authentication", vcr: true do
    it "returns error message" do
      get "/v3/dois/get-dois"
  ...
  describe "content_negotation", elasticsearch: true do
    ...
    context "no permission" do
      ...
      it "returns error message" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/vnd.jats+xml", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "no authentication" do
      ...
      it "returns error message" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/vnd.jats+xml" }
    ...
    context "application/vnd.datacite.datacite+xml" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/vnd.datacite.datacite+xml", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "application/vnd.datacite.datacite+xml not found" do
      it "returns error message" do
        get "/v3/dois/xxx", nil, { "HTTP_ACCEPT" => "application/vnd.datacite.datacite+xml", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "application/vnd.datacite.datacite+json" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/vnd.datacite.datacite+json", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "application/vnd.crosscite.crosscite+json" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/vnd.crosscite.crosscite+json", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "application/vnd.schemaorg.ld+json" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/vnd.schemaorg.ld+json", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "application/ld+json" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/ld+json", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "application/vnd.citationstyles.csl+json" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/vnd.citationstyles.csl+json", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "application/x-research-info-systems" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/x-research-info-systems", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "application/x-bibtex" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/x-bibtex", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "text/csv" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "text/csv", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "text/x-bibliography" do
      context "default style" do
        it "returns the Doi" do
          get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "text/x-bibliography", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
      ...
      context "ieee style" do
        it "returns the Doi" do
          get "/v3/dois/#{datacite_doi.doi}?style=ieee", nil, { "HTTP_ACCEPT" => "text/x-bibliography", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
      ...
      context "style and locale" do
        it "returns the Doi" do
          get "/v3/dois/#{datacite_doi.doi}?style=vancouver&locale=de", nil, { "HTTP_ACCEPT" => "text/x-bibliography", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "unknown content type" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_ACCEPT" => "application/vnd.ms-excel", "HTTP_AUTHORIZATION" => "Bearer " + bearer }
    ...
    context "missing content type" do
      it "returns the Doi" do
        get "/v3/dois/#{datacite_doi.doi}", nil, { "HTTP_AUTHORIZATION" => "Bearer " + bearer }
