  ...
  describe 'GET /dois/DOI/media/:id' do
    context 'when the record exists' do
      it 'returns the media' do
        get "/dois/#{datacite_doi.doi}/media/#{media.uid}", nil, headers
    ...
    context 'when the record does not exist' do
      it 'returns status code 404' do
        get "/dois/#{datacite_doi.doi}/media/xxxx", nil, headers
  ...
  describe 'POST /media' do
    context 'when the request is valid' do
      ...
      it 'creates a media record' do
        post "/dois/#{datacite_doi.doi}/media", valid_attributes, headers
  ...
  describe 'PATCH /dois/DOI/media/:id' do
    context 'when the request is valid' do
      ...
      it 'updates the record' do
        patch "/dois/#{datacite_doi.doi}/media/#{media.uid}", valid_attributes, headers
    ...
    context 'when the request is invalid' do
      ...
      it 'returns status code 422' do
        patch "/dois/#{datacite_doi.doi}/media/#{media.uid}", params, headers
  ...
  describe 'DELETE /dois/DOI/media/:id' do
    context 'when the resources does exist' do
      it 'returns status code 204' do
        delete "/dois/#{datacite_doi.doi}/media/#{media.uid}", nil, headers
    ...
    context 'when the resources doesnt exist' do
      it 'returns status code 404' do
        delete "/dois/#{datacite_doi.doi}/media/xxx", nil, headers
