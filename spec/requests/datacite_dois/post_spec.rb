...
describe DataciteDoisController, type: :request, vcr: true do
  ...
  describe "POST /dois" do
    ...
    context "when the request is valid with valid geoLocation properties - geoLocationPoint" do
      let(:valid_attributes) do
        {
          "data" => {
            "type" => "dois",
      ...
      it "creates a Doi - with geoLocation properties - geoLocationPoint" do
        post "/dois", valid_attributes, headers
    ...
    context "when the request is valid with valid geoLocation properties - geoLocationBox" do
      let(:valid_attributes) do
        {
          "data" => {
            "type" => "dois",
    ...
    context "when the request is valid with valid geoLocation properties - geoLocationPolygon" do
                    ...
                    #   },
                      {
                          "polygonPoint" => {
                              ...
                              "pointLatitude" => 43.5507063
                          }
                      },
                      {
                          "polygonPoint" => {
                              "pointLongitude" => -95.8904129,
                              "pointLatitude" => 43.4550805
                          }
                      },
                      {
                          "polygonPoint" => {
                              "pointLongitude" => -96.0222488,
                              "pointLatitude" => 37.9811922
                          }
                      },
                      {
                          "polygonPoint" => {
                              "pointLongitude" => -90.50711210,
                              "pointLatitude" => 37.7730685
                          }
                      },
                      {
                          "polygonPoint" => {
                              "pointLongitude" => -85.7390457,
                              "pointLatitude" => 40.7661566
                          }
                      },
                      {
                          "polygonPoint" => {
      ...
      it "creates a Doi - with geoLocation properties - geoLocationPolygon" do
        post "/dois", valid_attributes, headers
