...
describe WorkType do
  ...
  describe "query works", elasticsearch: true, vcr: true do
    ...
    let!(:works) { create_list(:doi, 10, aasm_state: "findable", client: client_without_ror, creators:
      [{
        "familyName" => "Garza",
        "givenName" => "Kristian",
        "name" => "Garza, Kristian",
        ...
        "nameType" => "Personal" }]) }
    let!(:doi) { create(:doi, aasm_state: "findable", client: client_without_ror, creators:
      [{
        "familyName" => "Garza",
        "givenName" => "Kristian",
        "name" => "Garza, Kristian",
    ...
    let!(:funder_doi) { create(:doi, aasm_state: "findable", client: client_without_ror, funding_references:
      [{
