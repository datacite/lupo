class ExportsController < ApplicationController
  ...
  def contacts
    ...
    begin
      ...
      add_contact = Proc.new do |contacts, email, id, firstname, lastname, type|
        if email
          fabrica_id = id + "-" + email
    ...
    rescue StandardError, Elasticsearch::Transport::Transport::Errors::BadRequest => e
      Raven.capture_exception(e)

      render json: { "errors" => { "title" => e.message } }.to_json, status: :bad_request
    end
  end
