...
class ClientPrefixesController < ApplicationController
  ...
  def index
    ...
    begin
      ...
      render json: ClientPrefixSerializer.new(client_prefixes, options).serialized_json,
             status: :ok
  ...
  def show
    ...
    render json: ClientPrefixSerializer.new(@client_prefix, options).serialized_json,
           status: :ok
  end
