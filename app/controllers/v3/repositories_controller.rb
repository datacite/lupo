...
class V3::RepositoriesController < ApplicationController
      ...
      respond_to do |format|
        format.json do
          ...
          if fields
            ...
            render json:
            V3::RepositorySerializer.new(response.results, options).
                       serialized_json,
                   status: :ok
          end
        end
  ...
  def show
    ...
    render json: V3::RepositorySerializer.new(repository, options).serialized_json,
           status: :ok
  end
  ...
  def create
    ...
    if @client.save
      ...
      render json: V3::RepositorySerializer.new(@client, options).serialized_json,
             status: :created
    else
