      ...
      begin
        ...
        if page[:scroll].present?
          ...
          if fields
            ...
            render json:
            V3::DataciteDoiSerializer.new(results, options).serialized_json,
                  status: :ok
          end
        else
          ...
          respond_to do |format|
            format.json do
              ...
              if fields
                ...
                render json:
                V3::DataciteDoiSerializer.new(results, options).
                          serialized_json,
                      status: :ok
              end
            end
    ...
    def show
      ...
      respond_to do |format|
        format.json do
          ...
          render json: V3::DataciteDoiSerializer.new(doi, options).serialized_json,
                status: :ok
        end
