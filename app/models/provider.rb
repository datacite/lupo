...
class Provider < ApplicationRecord
  audited except: %i[globus_uuid salesforce_id password updated experiments comments logo version doi_quota_allowed doi_quota_used]
