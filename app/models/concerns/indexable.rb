module Indexable
  ...
  module ClassMethods
    ...
    def query(query, options={})
      ...
      query_fields = options[:query_fields].presence || query_fields

      must = []
      must << { multi_match: { query: query, query_fields: query_fields, type: "phrase_prefix", slop: 3, max_expansions: 10 }} if query.present?
