...
class Organization
  ...
  def self.find_by_id(id)
    ...
    url = "https://api.ror.org/v1/organizations/#{ror_id}"
  ...
  def self.find_by_grid_id(id)
    ...
    url = "https://api.ror.org/v1/organizations?query=\"#{grid_id}\""
    response = Maremma.get(url, host: true, skip_encoding: true)
  ...
  def self.find_by_crossref_funder_id(id)
    ...
    url =
      "https://api.ror.org/v1/organizations?query=\"#{
  ...
  def self.query(query, options = {})
    ...
    url = "https://api.ror.org/v1/organizations?page=#{page}"
