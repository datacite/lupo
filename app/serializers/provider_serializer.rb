class ProviderSerializer
  ...
  attributes :name, :display_name, :symbol, :website, :system_email, :group_email, :description, :region, :country, :logo_url, :member_type, :organization_type, :focus_area, :non_profit_status, :is_active, :has_password, :joined, :twitter_handle, :billing_information, :ror_id, :salesforce_id, :cumulative_years, :technical_contact, :secondary_technical_contact, :billing_contact, :secondary_billing_contact, :service_contact, :secondary_service_contact, :voting_contact, :created, :updated
